...
<h1 class='text-center' style='font-size:30px; color:DodgerBlue;'>
  Поделитесь вашим мнением о нашем сервисе
</h1>

<p class='text-center' style="color:DodgerBlue;">
  Оставьте отзыв и напишите что понравилось и что не устроило, мы всегда за здоровую критику и учитываем пожелания всех пользователей сервиса, прислушиваемся ко всем мелочам.
</p>
